    ...
    >
      ...
      {personalInfo.summary && (
        <section className="mb-8 break-inside-avoid">
          <h3 className="text-lg font-bold uppercase border-b-2 border-gray-300 mb-3 pb-1">Summary</h3>
      ...
      {experience.length > 0 && (
        <section className="mb-8">
          <h3 className="text-lg font-bold uppercase border-b-2 border-gray-300 mb-3 pb-1">Work Experience</h3>
      ...
      {personalInfo.drivingLicense && (
        <section className="mb-8">
          <h3 className="text-lg font-bold uppercase border-b-2 border-gray-300 mb-3 pb-1">Driving License</h3>
