    ...
    >
      ...
      {personalInfo.summary && (
        <section className="mb-8 break-inside-avoid">
          <h3 className="text-lg font-bold border-b-2 mb-3 pb-1" style={{ color: themeColor, borderColor: themeColor }}>{"Zusammenfassung".toLocaleUpperCase('de-DE')}</h3>
      ...
      {skills.length > 0 && (
        <section className="mb-8 break-inside-avoid">
          <h3 className="text-lg font-bold border-b-2 mb-3 pb-1" style={{ color: themeColor, borderColor: themeColor }}>{"Kenntnisse".toLocaleUpperCase('de-DE')}</h3>
      ...
      {experience.length > 0 && (
        <section className="mb-8">
          <h3 className="text-lg font-bold border-b-2 mb-3 pb-1" style={{ color: themeColor, borderColor: themeColor }}>{"Berufserfahrung".toLocaleUpperCase('de-DE')}</h3>
      ...
      {projects.length > 0 && (
        <section className="mb-8">
          <h3 className="text-lg font-bold border-b-2 mb-3 pb-1" style={{ color: themeColor, borderColor: themeColor }}>{"Projekte".toLocaleUpperCase('de-DE')}</h3>
          <div className="space-y-6">
            {projects.map((proj) => (
      ...
      {education.length > 0 && (
        <section className="mb-8">
          <h3 className="text-lg font-bold border-b-2 mb-3 pb-1" style={{ color: themeColor, borderColor: themeColor }}>{"Ausbildung".toLocaleUpperCase('de-DE')}</h3>
      ...
      {languages && languages.length > 0 && (
        <section className="mb-8">
          <h3 className="text-lg font-bold border-b-2 mb-3 pb-1" style={{ color: themeColor, borderColor: themeColor }}>{"Sprachen".toLocaleUpperCase('de-DE')}</h3>
      ...
      {personalInfo.drivingLicense && (
        <section className="mb-8">
          <h3 className="text-lg font-bold border-b-2 mb-3 pb-1" style={{ color: themeColor, borderColor: themeColor }}>{"Führerschein".toLocaleUpperCase('de-DE')}</h3>
      ...
      {references.length > 0 && (
        <section className="mb-8">
          <h3 className="text-lg font-bold border-b-2 mb-3 pb-1" style={{ color: themeColor, borderColor: themeColor }}>{"Referenzen".toLocaleUpperCase('de-DE')}</h3>
